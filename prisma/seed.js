...
const barcode = (i) => `SMP-${(0, dayjs_1.default)().format("YYMMDD")}-${String(i).padStart(5, "0")}`;
const bagNo = (i) => `BB-${(0, dayjs_1.default)().format("YYMM")}-${String(i).padStart(4, "0")}`;
const admNo = (i) => `ADM-${(0, dayjs_1.default)().format("YYMMDD")}-${String(i).padStart(4, "0")}`;
async function main() {
        ...
        data: {
            ...
            subscription: {
                create: {
                    ...
                    plan: client_1.SubscriptionPlan.MEDIUM,
                    status: client_1.SubscriptionStatus.ACTIVE,
                    billingCycle: client_1.BillingCycle.MONTHLY,
                    monthlyPrice: 8000,
                    maxBranches: 3, maxUsers: 30, maxPatientsMonth: 2500, maxStorageGb: 25,
                    billingCycleStart: (0, dayjs_1.default)().startOf("month").toDate(),
                    billingCycleEnd: (0, dayjs_1.default)().endOf("month").toDate(),
                    nextBillingDate: (0, dayjs_1.default)().endOf("month").toDate(),
                    paymentMethodNote: [
    ...
    const admin = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.SUPER_ADMIN, designation: "System Administrator",
        },
    });
    const recep = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.RECEPTIONIST, designation: "Senior Receptionist",
        },
    });
    const labTech = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.LAB_TECHNICIAN, designation: "Senior Lab Technician",
        },
    });
    const doctor = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.DOCTOR, designation: "Consultant Pathologist",
    ...
    const accountant = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.ACCOUNTANT, designation: "Chief Accountant",
        },
    });
    const nurse = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.NURSE, designation: "Senior Staff Nurse",
        },
    });
    const pharmacist = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.PHARMACIST, designation: "Chief Pharmacist",
        },
    });
    const hrMgr = await prisma.user.create({
        data: {
            ...
            role: client_1.UserRole.HR_MANAGER, designation: "HR Manager",
        },
    });
    const surgeon = await prisma.user.create({
        data: {
            ...
            passwordHash: await hash("doctor123"),
            role: client_1.UserRole.DOCTOR, designation: "Consultant Surgeon",
    ...
    const cardiologist = await prisma.user.create({
        data: {
            ...
            passwordHash: await hash("doctor123"),
            role: client_1.UserRole.DOCTOR, designation: "Consultant Cardiologist",
    ...
    const gyne = await prisma.user.create({
        data: {
            ...
            passwordHash: await hash("doctor123"),
            role: client_1.UserRole.DOCTOR, designation: "Consultant Gynaecologist",
    ...
    const patientsData = [
        { name: "Md. Rahim Uddin", phone: "01911111111", dob: "1985-04-12", gender: client_1.Gender.MALE, address: "Dhanmondi, Dhaka", bloodGroup: "B+" },
        { name: "Fatema Begum", phone: "01911111112", dob: "1992-08-03", gender: client_1.Gender.FEMALE, address: "Mirpur, Dhaka", bloodGroup: "A+" },
        { name: "Karim Sheikh", phone: "01911111113", dob: "1978-12-22", gender: client_1.Gender.MALE, address: "Uttara, Dhaka", bloodGroup: "O+" },
        { name: "Nasrin Akter", phone: "01911111114", dob: "1995-06-18", gender: client_1.Gender.FEMALE, address: "Mohammadpur, Dhaka", bloodGroup: "AB+" },
        { name: "Hasan Mahmud", phone: "01911111115", dob: "1980-01-30", gender: client_1.Gender.MALE, address: "Banani, Dhaka", bloodGroup: "B-" },
        { name: "Sumi Rahman", phone: "01911111116", dob: "1998-03-25", gender: client_1.Gender.FEMALE, address: "Gulshan, Dhaka", bloodGroup: "O-" },
        { name: "Saiful Alam", phone: "01911111117", dob: "1965-11-08", gender: client_1.Gender.MALE, address: "Mohakhali, Dhaka", bloodGroup: "A-" },
        { name: "Roksana Khatun", phone: "01911111118", dob: "1972-07-15", gender: client_1.Gender.FEMALE, address: "Old Dhaka", bloodGroup: "B+" },
        { name: "Sajid Hossain", phone: "01911111119", dob: "2010-09-04", gender: client_1.Gender.MALE, address: "Bashundhara, Dhaka", bloodGroup: "O+" },
        { name: "Anika Tabassum", phone: "01911111120", dob: "2018-02-14", gender: client_1.Gender.FEMALE, address: "Mohammadpur, Dhaka", bloodGroup: "A+" },
    ];
    const patients = [];
    ...
    const inv1 = await prisma.invoice.create({
        data: {
            ...
            invoiceNumber: `INV-${(0, dayjs_1.default)().format("YYMMDD")}-00001`,
    ...
    const order1 = await prisma.testOrder.create({
        data: {
            ...
            orderNumber: `ORD-${(0, dayjs_1.default)().format("YYMMDD")}-00001`,
    ...
    await prisma.payment.create({
        data: {
            ...
            method: client_1.PaymentMethod.BKASH, referenceNo: "BKS123456789",
    ...
    await prisma.report.create({
        data: {
            ...
            submittedAt: (0, dayjs_1.default)().subtract(2, "hour").toDate(),
            approvedAt: (0, dayjs_1.default)().subtract(1, "hour").toDate(),
            qrToken: qrToken(),
    ...
    await prisma.report.create({
        data: {
            ...
            submittedAt: (0, dayjs_1.default)().subtract(30, "minute").toDate(),
    ...
    const inv2 = await prisma.invoice.create({
        data: {
            ...
            invoiceNumber: `INV-${(0, dayjs_1.default)().format("YYMMDD")}-00002`,
    ...
    const order2 = await prisma.testOrder.create({
        data: {
            ...
            orderNumber: `ORD-${(0, dayjs_1.default)().format("YYMMDD")}-00002`,
    ...
    await prisma.payment.create({
        data: { tenantId: tenant.id, invoiceId: inv2.id, amount: 500, method: client_1.PaymentMethod.CASH, collectedById: accountant.id },
    });
    await prisma.report.create({
    ...
    const inv3 = await prisma.invoice.create({
        data: {
            ...
            invoiceNumber: `INV-${(0, dayjs_1.default)().format("YYMMDD")}-00003`,
    ...
    await prisma.testOrder.create({
        data: {
            tenantId: tenant.id, branchId: uttara.id, patientId: patients[2].id,
            orderedById: admin.id,
            orderNumber: `ORD-${(0, dayjs_1.default)().format("YYMMDD")}-00003`,
    ...
    for (let i = 0; i < 10; i++) {
        ...
        const opening = 500;
        const expiry = (0, dayjs_1.default)().add(18, "month").toDate();
        const batch = await prisma.medicineBatch.create({
            data: {
                ...
                batchNumber: `B${(0, dayjs_1.default)().format("YYMM")}${String(i + 1).padStart(3, "0")}`,
    ...
    const saleNo = `PHS-${(0, dayjs_1.default)().format("YYMMDD")}-0001`;
    ...
    const saleInv = await prisma.invoice.create({
        data: {
            tenantId: tenant.id, branchId: dhanmondi.id, patientId: patients[0].id,
            invoiceNumber: `INV-${(0, dayjs_1.default)().format("YYMMDD")}-00010`,
    ...
    await prisma.payment.create({
        data: { tenantId: tenant.id, invoiceId: saleInv.id, amount: saleAmount, method: client_1.PaymentMethod.CASH, collectedById: pharmacist.id },
    });
    // ── Doctor schedules ──
    ...
    const aptTomorrow = (0, dayjs_1.default)().add(1, "day").hour(17).minute(0).second(0).millisecond(0);
    const apt1 = await prisma.appointment.create({
        data: {
            ...
            tokenNumber: 1, status: client_1.AppointmentStatus.BOOKED, visitType: client_1.VisitType.NEW,
    ...
    const apt2 = await prisma.appointment.create({
        data: {
            ...
            slotStart: (0, dayjs_1.default)().subtract(2, "day").hour(18).minute(30).toDate(),
            slotEnd: (0, dayjs_1.default)().subtract(2, "day").hour(19).minute(0).toDate(),
            tokenNumber: 5, status: client_1.AppointmentStatus.COMPLETED, visitType: client_1.VisitType.FOLLOW_UP,
    ...
    const consult1 = await prisma.consultation.create({
        data: {
            ...
            followUpDate: (0, dayjs_1.default)().add(30, "day").toDate(),
            completedAt: (0, dayjs_1.default)().subtract(2, "day").toDate(),
        },
    });
    ...
    const notice1 = await prisma.notice.create({
        data: {
            ...
            audience: client_1.NoticeAudience.ALL_STAFF, pinned: true,
        },
    });
    await prisma.notice.create({
        data: {
            ...
            audience: client_1.NoticeAudience.ALL_STAFF, pinned: false,
        },
    });
    await prisma.notice.create({
        data: {
            ...
            audience: client_1.NoticeAudience.NURSES,
        },
    });
    ...
    await prisma.patientHealthCard.create({
        data: {
            ...
            cardNumber: `HC-${(0, dayjs_1.default)().format("YY")}-00001`,
            issuedAt: (0, dayjs_1.default)().subtract(2, "month").toDate(),
            expiresAt: (0, dayjs_1.default)().add(10, "month").toDate(),
        },
    });
    // ── Wards & beds + Admission ────────────────────
    const wardGeneral = await prisma.ward.create({
        data: { tenantId: tenant.id, branchId: dhanmondi.id, name: "General Male Ward", floor: "2nd", type: client_1.WardType.GENERAL },
    });
    const wardCabin = await prisma.ward.create({
        data: { tenantId: tenant.id, branchId: dhanmondi.id, name: "Premium Cabin", floor: "3rd", type: client_1.WardType.CABIN },
    });
    const wardIcu = await prisma.ward.create({
        data: { tenantId: tenant.id, branchId: dhanmondi.id, name: "ICU", floor: "4th", type: client_1.WardType.ICU },
    });
    const beds = [];
    for (let i = 1; i <= 6; i++) {
        beds.push(await prisma.bed.create({
            data: { tenantId: tenant.id, wardId: wardGeneral.id, code: `GM-${String(i).padStart(2, "0")}`, dailyRate: 1200, status: i === 1 ? client_1.BedStatus.OCCUPIED : client_1.BedStatus.AVAILABLE },
        }));
    }
    for (let i = 1; i <= 4; i++) {
        beds.push(await prisma.bed.create({
            data: { tenantId: tenant.id, wardId: wardCabin.id, code: `CB-${String(i).padStart(2, "0")}`, dailyRate: 3500, status: i === 1 ? client_1.BedStatus.OCCUPIED : client_1.BedStatus.AVAILABLE },
        }));
    }
    for (let i = 1; i <= 4; i++) {
        beds.push(await prisma.bed.create({
            data: { tenantId: tenant.id, wardId: wardIcu.id, code: `ICU-${String(i).padStart(2, "0")}`, dailyRate: 7500, status: client_1.BedStatus.AVAILABLE },
        }));
    }
    ...
    const admInv = await prisma.invoice.create({
        data: {
            ...
            invoiceNumber: `INV-${(0, dayjs_1.default)().format("YYMMDD")}-00100`,
    ...
    const admission1 = await prisma.admission.create({
        data: {
            ...
            admittedAt: (0, dayjs_1.default)().subtract(3, "day").toDate(),
    ...
    await prisma.bedAllocation.create({
        data: { admissionId: admission1.id, bedId: beds[0].id, fromTs: (0, dayjs_1.default)().subtract(3, "day").toDate() },
    });
    ...
    for (let d = 0; d < 3; d++) {
        await prisma.ipdCharge.create({
            data: {
                ...
                chargeDate: (0, dayjs_1.default)().subtract(3 - d, "day").toDate(),
                chargeType: client_1.IpdChargeType.BED, description: "General Ward bed (day rate)",
    ...
    await prisma.doctorVisit.create({
        data: { tenantId: tenant.id, admissionId: admission1.id, doctorId: surgeon.id, visitAt: (0, dayjs_1.default)().subtract(2, "day").toDate(), note: "Reviewing pre-op labs. Plan: laparoscopic chole tomorrow.", fee: 1500 },
    });
    ...
    const donor1 = await prisma.bloodDonor.create({
        data: {
            ...
            nid: "1990123456789", bloodGroup: client_1.BloodGroup.O_POS,
            dob: new Date("1990-01-15"), gender: client_1.Gender.MALE, address: "Mirpur 10, Dhaka",
            occupation: "Bank officer", totalDonations: 8,
            lastDonatedAt: (0, dayjs_1.default)().subtract(4, "month").toDate(),
        },
    });
    const donor2 = await prisma.bloodDonor.create({
        data: {
            tenantId: tenant.id, name: "Fahim Ahmed", phone: "01911222002",
            bloodGroup: client_1.BloodGroup.A_POS, gender: client_1.Gender.MALE, totalDonations: 3,
            lastDonatedAt: (0, dayjs_1.default)().subtract(2, "month").toDate(),
        },
    });
    const donor3 = await prisma.bloodDonor.create({
        data: {
            tenantId: tenant.id, name: "Suraiya Akter", phone: "01911222003",
            bloodGroup: client_1.BloodGroup.B_POS, gender: client_1.Gender.FEMALE, totalDonations: 2,
        },
    });
    const bag1 = await prisma.bloodBag.create({
        data: {
            tenantId: tenant.id, donorId: donor1.id, bagNumber: bagNo(1),
            bloodGroup: client_1.BloodGroup.O_POS, component: client_1.BloodComponent.WHOLE_BLOOD, volumeMl: 450,
            collectedOn: (0, dayjs_1.default)().subtract(10, "day").toDate(),
            expiryDate: (0, dayjs_1.default)().add(25, "day").toDate(),
            status: client_1.BloodBagStatus.AVAILABLE, storageLocation: "Refrigerator A / Shelf 1",
        },
    });
    await prisma.bloodScreening.create({
        data: { bagId: bag1.id, hbsAg: client_1.ScreeningResult.NEGATIVE, hiv: client_1.ScreeningResult.NEGATIVE, hcv: client_1.ScreeningResult.NEGATIVE, vdrl: client_1.ScreeningResult.NEGATIVE, malaria: client_1.ScreeningResult.NEGATIVE, testedById: labTech.id, testedAt: (0, dayjs_1.default)().subtract(9, "day").toDate() },
    });
    const bag2 = await prisma.bloodBag.create({
        data: {
            tenantId: tenant.id, donorId: donor2.id, bagNumber: bagNo(2),
            bloodGroup: client_1.BloodGroup.A_POS, component: client_1.BloodComponent.PRBC, volumeMl: 250,
            collectedOn: (0, dayjs_1.default)().subtract(5, "day").toDate(),
            expiryDate: (0, dayjs_1.default)().add(30, "day").toDate(),
            status: client_1.BloodBagStatus.QUARANTINE, storageLocation: "Refrigerator A / Shelf 2",
        },
    });
    await prisma.bloodScreening.create({
        data: { bagId: bag2.id, hbsAg: client_1.ScreeningResult.PENDING, hiv: client_1.ScreeningResult.PENDING, hcv: client_1.ScreeningResult.PENDING, vdrl: client_1.ScreeningResult.PENDING, malaria: client_1.ScreeningResult.PENDING },
    });
    const bag3 = await prisma.bloodBag.create({
        data: {
            tenantId: tenant.id, donorId: donor3.id, bagNumber: bagNo(3),
            bloodGroup: client_1.BloodGroup.B_POS, component: client_1.BloodComponent.PLATELET, volumeMl: 60,
            collectedOn: (0, dayjs_1.default)().subtract(2, "day").toDate(),
            expiryDate: (0, dayjs_1.default)().add(3, "day").toDate(),
            status: client_1.BloodBagStatus.AVAILABLE,
        },
    });
    await prisma.bloodScreening.create({
        data: { bagId: bag3.id, hbsAg: client_1.ScreeningResult.NEGATIVE, hiv: client_1.ScreeningResult.NEGATIVE, hcv: client_1.ScreeningResult.NEGATIVE, vdrl: client_1.ScreeningResult.NEGATIVE, malaria: client_1.ScreeningResult.NEGATIVE, testedById: labTech.id },
    });
    // ── Ambulance ───────────────────────────────────
    const amb1 = await prisma.ambulance.create({
        data: {
            tenantId: tenant.id, branchId: dhanmondi.id,
            vehicleNumber: "DHA-METRO-LA-12-3456", type: client_1.AmbulanceType.AC,
    ...
    const amb2 = await prisma.ambulance.create({
        data: {
            tenantId: tenant.id, branchId: dhanmondi.id,
            vehicleNumber: "DHA-METRO-LA-22-1100", type: client_1.AmbulanceType.ICU,
    ...
    await prisma.ambulance.create({
        data: {
            tenantId: tenant.id, branchId: uttara.id,
            vehicleNumber: "DHA-METRO-LA-33-7788", type: client_1.AmbulanceType.NON_AC,
    ...
    await prisma.ambulanceTrip.create({
        data: {
            ...
            startedAt: (0, dayjs_1.default)().subtract(3, "day").subtract(1, "hour").toDate(),
            completedAt: (0, dayjs_1.default)().subtract(3, "day").toDate(),
            status: client_1.AmbulanceTripStatus.COMPLETED,
    ...
    await prisma.ambulanceTrip.create({
        data: {
            ...
            startedAt: (0, dayjs_1.default)().subtract(30, "minute").toDate(),
            status: client_1.AmbulanceTripStatus.EN_ROUTE,
        },
    });
    ...
    await prisma.patientVaccination.create({
        data: {
            ...
            givenAt: (0, dayjs_1.default)(patients[9].dob).add(7, "day").toDate(),
    ...
    await prisma.patientVaccination.create({
        data: {
            ...
            givenAt: (0, dayjs_1.default)(patients[9].dob).add(42, "day").toDate(),
            batchNumber: "EPI-PENTA-2018-B7", givenById: nurse.id,
            nextDueAt: (0, dayjs_1.default)(patients[9].dob).add(70, "day").toDate(),
        },
    });
    // ── Operating Theatre ───────────────────────────
    ...
    await prisma.otBooking.create({
        data: {
            ...
            scheduledStart: (0, dayjs_1.default)().add(1, "day").hour(10).toDate(),
            scheduledEnd: (0, dayjs_1.default)().add(1, "day").hour(12).toDate(),
            status: client_1.OtBookingStatus.SCHEDULED, fee: 35000,
        },
    });
    await prisma.otBooking.create({
        data: {
            ...
            scheduledStart: (0, dayjs_1.default)().subtract(2, "day").hour(14).toDate(),
            scheduledEnd: (0, dayjs_1.default)().subtract(2, "day").hour(15).toDate(),
            actualStart: (0, dayjs_1.default)().subtract(2, "day").hour(14).minute(5).toDate(),
            actualEnd: (0, dayjs_1.default)().subtract(2, "day").hour(15).minute(30).toDate(),
            status: client_1.OtBookingStatus.COMPLETED, fee: 12000,
        },
    });
    // ── Expenses (history for finance reports) ──────
    await prisma.expense.createMany({
        data: [
            { tenantId: tenant.id, branchId: dhanmondi.id, spentOn: (0, dayjs_1.default)().subtract(7, "day").toDate(), category: client_1.ExpenseCategory.RENT, description: "Dhanmondi office rent (March)", amount: 80000, paidVia: client_1.PaymentMethod.BANK_TRANSFER, vendorName: "Landlord", recordedById: accountant.id },
            { tenantId: tenant.id, branchId: dhanmondi.id, spentOn: (0, dayjs_1.default)().subtract(5, "day").toDate(), category: client_1.ExpenseCategory.UTILITIES, description: "DESCO electricity", amount: 14500, paidVia: client_1.PaymentMethod.BKASH, recordedById: accountant.id },
            { tenantId: tenant.id, branchId: dhanmondi.id, spentOn: (0, dayjs_1.default)().subtract(3, "day").toDate(), category: client_1.ExpenseCategory.SUPPLIES, description: "Sterile gloves x 1000", amount: 6500, paidVia: client_1.PaymentMethod.CASH, vendorName: "Sun Surgical", recordedById: pharmacist.id },
            { tenantId: tenant.id, branchId: uttara.id, spentOn: (0, dayjs_1.default)().subtract(2, "day").toDate(), category: client_1.ExpenseCategory.MAINTENANCE, description: "AC servicing", amount: 3200, paidVia: client_1.PaymentMethod.CASH, recordedById: accountant.id },
            { tenantId: tenant.id, branchId: dhanmondi.id, spentOn: (0, dayjs_1.default)().subtract(1, "day").toDate(), category: client_1.ExpenseCategory.MARKETING, description: "Local newspaper ad", amount: 12000, paidVia: client_1.PaymentMethod.BANK_TRANSFER, vendorName: "Prothom Alo", recordedById: admin.id },
        ],
    });
    ...
    await prisma.cashClose.create({
        data: {
            ...
            openedAt: (0, dayjs_1.default)().subtract(1, "day").hour(9).toDate(),
            closedAt: (0, dayjs_1.default)().subtract(1, "day").hour(21).toDate(),
            status: client_1.CashCloseStatus.CLOSED,
    ...
    await prisma.cashClose.create({
        data: {
            tenantId: tenant.id, branchId: dhanmondi.id, cashierId: recep.id,
            openedAt: (0, dayjs_1.default)().hour(9).toDate(), status: client_1.CashCloseStatus.OPEN,
            openingFloat: 5000,
        },
    });
    // ── Petty cash ──────────────────────────────────
    await prisma.pettyCashEntry.createMany({
        data: [
            { tenantId: tenant.id, branchId: dhanmondi.id, type: client_1.PettyCashType.TOP_UP, amount: 5000, description: "Opening top-up", voucherNo: "PC-001", recordedById: accountant.id, occurredOn: (0, dayjs_1.default)().subtract(7, "day").toDate() },
            { tenantId: tenant.id, branchId: dhanmondi.id, type: client_1.PettyCashType.PAYOUT, amount: 350, description: "Tea & snacks for staff meeting", voucherNo: "PC-002", recordedById: recep.id, occurredOn: (0, dayjs_1.default)().subtract(4, "day").toDate() },
            { tenantId: tenant.id, branchId: dhanmondi.id, type: client_1.PettyCashType.PAYOUT, amount: 600, description: "Stationery — printer paper", voucherNo: "PC-003", recordedById: recep.id, occurredOn: (0, dayjs_1.default)().subtract(2, "day").toDate() },
            { tenantId: tenant.id, branchId: dhanmondi.id, type: client_1.PettyCashType.TOP_UP, amount: 2000, description: "Replenishment", voucherNo: "PC-004", recordedById: accountant.id, occurredOn: (0, dayjs_1.default)().subtract(1, "day").toDate() },
        ],
    });
    // ── Commission payouts ──────────────────────────
    await prisma.commissionPayout.create({
        data: {
            ...
            periodFrom: (0, dayjs_1.default)().subtract(1, "month").startOf("month").toDate(),
            periodTo: (0, dayjs_1.default)().subtract(1, "month").endOf("month").toDate(),
            amount: 4500, method: client_1.PaymentMethod.BKASH, referenceNo: "BKS22334455",
    ...
    await prisma.patientFeedback.createMany({
        data: [
            { tenantId: tenant.id, patientId: patients[0].id, type: client_1.FeedbackType.FEEDBACK, rating: 5, subject: "Excellent service", message: "Got my CBC report within 4 hours. Staff was very polite. Thank you!", status: client_1.FeedbackStatus.OPEN },
            { tenantId: tenant.id, patientId: patients[1].id, type: client_1.FeedbackType.COMPLAINT, rating: 2, subject: "Long wait time", message: "Waited over 90 minutes for sample collection. Please improve queue management.", status: client_1.FeedbackStatus.IN_PROGRESS, assignedToId: hrMgr.id },
            { tenantId: tenant.id, type: client_1.FeedbackType.SUGGESTION, visitorName: "Anonymous visitor", visitorPhone: "01911000444", subject: "Add evening shift counter", message: "Would be helpful if billing counter stays open till 10 pm for working professionals.", status: client_1.FeedbackStatus.OPEN },
            { tenantId: tenant.id, patientId: patients[3].id, type: client_1.FeedbackType.FEEDBACK, rating: 4, subject: "Nice clinic", message: "Doctor was thorough. Slightly expensive but worth it.", status: client_1.FeedbackStatus.RESOLVED, response: "Thank you for the positive feedback!", respondedAt: new Date(), assignedToId: admin.id },
        ],
    });
    // ── Phase D: HR ─────────────────────────────────
    ...
    for (const t of termsData) {
        ...
        await prisma.employmentTerms.create({
            data: {
                userId: t.user.id, employmentType: client_1.EmploymentType.FULL_TIME,
                designation: t.user.designation, joinedAt: (0, dayjs_1.default)().subtract(2, "year").toDate(),
    ...
    await prisma.leaveRequest.create({
        data: {
            ...
            fromDate: (0, dayjs_1.default)().subtract(20, "day").toDate(),
            toDate: (0, dayjs_1.default)().subtract(19, "day").toDate(),
            days: 2, reason: "Family event", status: client_1.LeaveStatus.APPROVED,
            reviewedById: hrMgr.id, reviewedAt: (0, dayjs_1.default)().subtract(22, "day").toDate(),
            reviewNote: "Approved.",
        },
    });
    ...
    await prisma.leaveRequest.create({
        data: {
            ...
            fromDate: (0, dayjs_1.default)().add(2, "day").toDate(),
            toDate: (0, dayjs_1.default)().add(2, "day").toDate(),
            days: 1, reason: "Medical check-up", status: client_1.LeaveStatus.PENDING,
        },
    });
    // Staff loan
    await prisma.staffLoan.create({
        data: {
            ...
            monthlyDeduction: 5000, totalDeducted: 10000, status: client_1.LoanStatus.ACTIVE,
            reason: "Emergency family medical bill", takenOn: (0, dayjs_1.default)().subtract(2, "month").toDate(),
        },
    });
    // Attendance — last 7 days for all staff
    for (const u of allStaff) {
        for (let d = 7; d >= 1; d--) {
            const date = (0, dayjs_1.default)().subtract(d, "day").startOf("day");
            const dow = date.day(); // 0=Sun
            const status = dow === 5 ? client_1.AttendanceStatus.WEEKEND : // Friday in BD context
                (u.id === recep.id && d === 20) ? client_1.AttendanceStatus.LEAVE :
                    client_1.AttendanceStatus.PRESENT;
            await prisma.attendance.create({
                data: {
                    tenantId: tenant.id, branchId: dhanmondi.id, userId: u.id,
                    date: date.toDate(), status,
                    checkIn: status === client_1.AttendanceStatus.PRESENT ? date.hour(9).minute(5).toDate() : null,
                    checkOut: status === client_1.AttendanceStatus.PRESENT ? date.hour(18).minute(15).toDate() : null,
    ...
    for (let d = 0; d < 5; d++) {
        await prisma.dutyRoster.create({
            data: {
                ...
                date: (0, dayjs_1.default)().add(d, "day").toDate(),
            },
        });
        await prisma.dutyRoster.create({
            data: {
    ...
    for (const t of termsData) {
        ...
        await prisma.payslip.create({
            data: {
                ...
                status: t.user.id === nurse.id ? client_1.PayslipStatus.PENDING : client_1.PayslipStatus.PAID,
                paidAt: t.user.id === nurse.id ? null : prevMonth.endOf("month").toDate(),
                paidVia: t.user.id === nurse.id ? null : client_1.PaymentMethod.BANK_TRANSFER,
    ...
    const monthOf = (offset) => (0, dayjs_1.default)().startOf("month").subtract(offset, "month");
    for (let i = 2; i >= 1; i--) {
        ...
        const inv = await prisma.subscriptionInvoice.create({
            data: {
                tenantId: tenant.id,
                invoiceNumber: `SUB-${(0, dayjs_1.default)(periodFrom).format("YYMM")}-0001`,
                periodFrom, periodTo,
                dueDate: (0, dayjs_1.default)(periodFrom).add(14, "day").toDate(),
                ...
                paidAt: (0, dayjs_1.default)(periodFrom).add(5, "day").toDate(),
                lines: {
                    create: [{
                            description: `Medium subscription · ${(0, dayjs_1.default)(periodFrom).format("DD MMM YYYY")} – ${(0, dayjs_1.default)(periodTo).format("DD MMM YYYY")}`,
        ...
        await prisma.subscriptionInvoicePayment.create({
            data: {
                invoiceId: inv.id,
                amount: 8000,
                method: client_1.PaymentMethod.BKASH,
                referenceNo: `BK${(0, dayjs_1.default)(periodFrom).format("YYMM")}XX${1000 + i}`,
                paidAt: (0, dayjs_1.default)(periodFrom).add(5, "day").toDate(),
            },
        });
    }
    // Current month — still due
    const currentFrom = (0, dayjs_1.default)().startOf("month").toDate();
    const currentTo = (0, dayjs_1.default)().endOf("month").toDate();
    await prisma.subscriptionInvoice.create({
        data: {
            tenantId: tenant.id,
            invoiceNumber: `SUB-${(0, dayjs_1.default)().format("YYMM")}-0001`,
            periodFrom: currentFrom, periodTo: currentTo,
            dueDate: (0, dayjs_1.default)().add(14, "day").toDate(),
            status: client_1.SubscriptionInvoiceStatus.ISSUED,
            planCode: "MEDIUM", planName: "Medium",
            billingCycle: client_1.BillingCycle.MONTHLY,
            subtotal: 8000, discountAmount: 0, totalAmount: 8000,
            ...
            lines: {
                create: [{
                        description: `Medium subscription · ${(0, dayjs_1.default)(currentFrom).format("DD MMM YYYY")} – ${(0, dayjs_1.default)(currentTo).format("DD MMM YYYY")}`,
                        qty: 1, unitPrice: 8000, amount: 8000,
                    }],
            },
        },
    ...
    const grameenphone = await prisma.corporateClient.create({
        data: {
            ...
            type: client_1.CorporateClientType.COMPANY,
    ...
    await prisma.corporateClient.create({
        data: {
            ...
            type: client_1.CorporateClientType.INSURANCE,
    ...
    await prisma.corporateStatement.create({
        data: {
            ...
            statementNumber: `CST-${(0, dayjs_1.default)().subtract(1, "month").format("YYMMDD")}-0001`,
            periodFrom: (0, dayjs_1.default)().subtract(1, "month").startOf("month").toDate(),
            periodTo: (0, dayjs_1.default)().subtract(1, "month").endOf("month").toDate(),
            invoiceIds: [],
            subtotal: 12500, discountAmount: 1250, netPayable: 11250,
            paidAmount: 0, dueAmount: 11250,
            status: client_1.CorporateStatementStatus.GENERATED,
            dueDate: (0, dayjs_1.default)().add(15, "day").toDate(),
            generatedAt: (0, dayjs_1.default)().subtract(1, "week").toDate(),
        },
    });
    // ── Support tickets ──────────────────────────────────
    ...
    const t1 = await prisma.supportTicket.create({
        data: {
            tenantId: tenant.id,
            ticketNumber: `SUP-${(0, dayjs_1.default)().subtract(3, "day").format("YYMMDD")}-0001`,
            title: "Cannot generate report PDF for some patients",
            category: client_1.SupportTicketCategory.BUG,
            severity: client_1.SupportTicketSeverity.HIGH,
            status: client_1.SupportTicketStatus.IN_PROGRESS,
            createdById: admin.id,
            lastMessageAt: (0, dayjs_1.default)().subtract(1, "day").toDate(),
            lastMessageSide: client_1.SupportMessageSide.PLATFORM,
    ...
    await prisma.supportTicketMessage.create({
        data: {
            ticketId: t1.id,
            side: client_1.SupportMessageSide.TENANT,
            authorId: admin.id,
            ...
            createdAt: (0, dayjs_1.default)().subtract(3, "day").toDate(),
        },
    });
    await prisma.supportTicketMessage.create({
        data: {
            ticketId: t1.id,
            side: client_1.SupportMessageSide.PLATFORM,
            authorId: admin.id,
            ...
            createdAt: (0, dayjs_1.default)().subtract(1, "day").toDate(),
        },
    });
    await prisma.supportTicket.create({
        data: {
            tenantId: tenant.id,
            ticketNumber: `SUP-${(0, dayjs_1.default)().subtract(5, "day").format("YYMMDD")}-0002`,
            title: "Please add Radiology module to our plan",
            category: client_1.SupportTicketCategory.FEATURE_REQUEST,
            severity: client_1.SupportTicketSeverity.MEDIUM,
            status: client_1.SupportTicketStatus.RESOLVED,
            createdById: admin.id,
            lastMessageAt: (0, dayjs_1.default)().subtract(2, "day").toDate(),
            lastMessageSide: client_1.SupportMessageSide.PLATFORM,
            platformUnread: false,
            tenantUnread: false,
            resolvedAt: (0, dayjs_1.default)().subtract(2, "day").toDate(),
            messages: {
                create: [
                    {
                        side: client_1.SupportMessageSide.TENANT,
                        ...
                        createdAt: (0, dayjs_1.default)().subtract(5, "day").toDate(),
                    },
                    {
                        side: client_1.SupportMessageSide.PLATFORM,
                        authorId: admin.id,
                        ...
                        createdAt: (0, dayjs_1.default)().subtract(2, "day").toDate(),
                    },
                ],
            },
        },
    ...
    await prisma.supportTicket.create({
        data: {
            tenantId: tenant.id,
            ticketNumber: `SUP-${(0, dayjs_1.default)().format("YYMMDD")}-0003`,
            title: "How to mark an invoice as partially paid?",
            category: client_1.SupportTicketCategory.QUESTION,
            severity: client_1.SupportTicketSeverity.LOW,
            status: client_1.SupportTicketStatus.RECEIVED,
            createdById: recep.id,
            lastMessageAt: (0, dayjs_1.default)().subtract(1, "hour").toDate(),
            lastMessageSide: client_1.SupportMessageSide.TENANT,
            platformUnread: true,
            tenantUnread: false,
            messages: {
                create: [{
                        ...
                        createdAt: (0, dayjs_1.default)().subtract(1, "hour").toDate(),
                    }],
            },
        },
    });
    ...
    const trialEnd = (0, dayjs_1.default)().add(10, "day").toDate();
        ...
        data: {
            ...
            subscription: {
                create: {
                    ...
                    plan: client_1.SubscriptionPlan.SMALL,
                    ...
                    billingCycleStart: (0, dayjs_1.default)().subtract(4, "day").toDate(),
    ...
    await prisma.subscriptionEvent.create({
        data: {
            tenantId: tenant2.id,
            eventType: "SIGNUP",
            notes: `Signup via web. Trial until ${(0, dayjs_1.default)(trialEnd).format("YYYY-MM-DD")}.`,
        },
    });
    console.log("\n  ✅  Seed complete.\n");
